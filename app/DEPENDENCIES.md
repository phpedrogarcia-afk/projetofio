# Android dependency inventory — M1

Status: Resolved M1 checkpoint; lockfile and SHA-256 verification metadata generated
...
The release manifest has no `INTERNET` or storage permission. AndroidX Biometric
